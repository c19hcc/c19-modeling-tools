...
## unzip linelist file used in r_t calculations; req to zip due to github size limitations
utils::unzip(zipfile = "./data/rt_calcs/data/linelist.zip")
utils::unzip(zipfile = "./www/data/rt_calcs/data/linelist.zip")
